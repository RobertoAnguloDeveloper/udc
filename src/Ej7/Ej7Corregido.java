...
import EstructurasDatos.PilaRepetidosCorregido;
import javax.swing.JOptionPane;

public class Ej7Corregido {

    public static void main(String[] args) {
        PilaRepetidosCorregido pila = new PilaRepetidosCorregido();
        ...
        do{
            int op1 = JOptionPane.showOptionDialog(null, "QUE OPERACION DESEA REALIZAR?"
                    , "PILA ELIMINA REPETIDO",JOptionPane.YES_NO_CANCEL_OPTION 
